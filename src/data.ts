      ...
      equipmentCategories: [
        {
          ...
          items: [
            { name: "Máy làm sữa hạt bán công nghiệp", desc: "Dung tích 1.75L - 2L, công suất lớn (xay & nấu kết hợp). Khuyên dùng: Unie, Ranbem hoặc vắt ly tâm nếu làm quy mô lớn hơn." },
            { name: "Túi lọc sữa chuyên dụng", desc: "Chất liệu vải nilon an toàn thực phẩm, mắt lưới siêu nhỏ để sữa không bị lợn cợn (rất quan trọng)." },
            { name: "Cân tiểu ly điện tử", desc: "Độ chính xác 0.1g, dùng để cân chuẩn xác các loại hạt, đường, muối cho đồng đều chất lượng." },
            { name: "Ca đong định lượng (Pitcher)", desc: "Loại nhựa trong suốt có vạch chia ml (Dung tích 1L và 2L)." },
            { name: "Nhiệt kế thực phẩm", desc: "Đo nhiệt độ sữa khi thanh trùng và làm nguội (canh nhiệt độ để tránh sữa bị chua)." },
            { name: "Phới lồng (Whisk) cỡ lớn", desc: "Dùng để khuấy đều sữa và đường phèn/sữa đặc khi nấu." }
          ]
        },
        {
          name: "Nhóm Dụng Cụ Vận Hành & Bán Hàng",
          items: [
            { name: "Xe đẩy / Quầy gấp gọn", desc: "Kích thước 1m - 1.2m, có bánh xe khóa, mặt bàn inox dễ vệ sinh." },
            { name: "Thùng đá giữ nhiệt", desc: "Loại 2 lớp, dung tích 35L - 50L. Dùng để ủ lạnh chai sữa (bán tới đâu lấy ra tới đó để đảm bảo độ tươi)." },
            { name: "Chai nhựa PET & Nắp niêm phong", desc: "Dung tích 330ml kiểu dáng vuông hoặc tròn trơn, nắp có đai niêm phong (tạo sự chuyên nghiệp, an tâm)." },
            { name: "Tem nhãn Decal", desc: "In sẵn logo, tên món, ngày sản xuất và hạn sử dụng (tick tay). Có khả năng chống nước." },
            { name: "Túi nilon chữ T / Túi xách giấy", desc: "Túi chữ T tiết kiệm chi phí, dễ xách đi đường." },
            { name: "Bảng Menu Mica để bàn", desc: "Bảng A4 hoặc A5 đứng, in rõ giá tiền và hình ảnh hấp dẫn." }
          ]
        }
      ]
    },
